...
if(debug_on) {
    ...
    draw_text_transformed(20, 240, "global.height: " + string(height), 2, 2, 0);
    draw_text_transformed(20, 260, "global.next_height: " + string(next_height), 2, 2, 0);
    draw_text_transformed(20, 282, "platform count " + string(instance_number(obj_platform_parent)), 2, 2, 0);
	if(m_held || t_held) {
